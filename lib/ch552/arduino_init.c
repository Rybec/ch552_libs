...
// clang-format off
// The following were moved to wiring.c, since that's the only place
// they are used, and because they are explicitly addressed, allowing
// them to be redeclared anywhere they are needed without any potential
// for conflict that doesn't already exist.
